<x-guest-layout>
    ...
    <div class="mb-6 text-center">
        <h2 class="text-2xl font-heading font-bold text-white mb-2">Bem-vindo de volta</h2>
        <p class="text-sm text-prowise-softblue">Acesse sua conta para continuar</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between mt-6">
            <label for="remember_me" class="inline-flex items-center group cursor-pointer">
                ...
                <span class="ms-2 text-sm text-prowise-softblue group-hover:text-white transition-colors">Lembrar de mim</span>
            </label>
